...
const Footer = () => {
  return (
    <footer style={{ backgroundColor: '#6c6c6c', color: 'white', paddingTop: '40px' }}>
      {/* Contenedor centrado para mantener proporciones */}
      <div style={{
        maxWidth: '1200px',
        margin: 'auto',
        padding: '0 20px',
        ...
        <div style={{
          ...
          {/* Izquierda: Logo + título + redes */}
          <div style={{ minWidth: '250px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '10px' }}>
              <img src={logoag1} alt="AG Mantenimiento" style={{ width: '70px' }} />
              <p style={{ fontSize: '1.5rem', fontWeight: 'bold', lineHeight: '1.2', margin: 0 }}>
          ...
          <div style={{ minWidth: '250px', marginTop: '20px' }}>
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
              ...
              <span style={{ marginLeft: '10px' }}>+591 78593512</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
              <svg width="20" height="20" fill="white" viewBox="0 0 24 24">
              ...
              <span style={{ marginLeft: '10px' }}>Juan Latino 2790, Santa Cruz de la Sierra</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <span style={{ marginLeft: '10px' }}>bernardochavezcaba@gmail.com</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <p style={{ margin: 0 }}>AG MANTTO © 2025 TODOS LOS DERECHOS RESERVADOS</p>
      </div>
    </footer>
  );
};
